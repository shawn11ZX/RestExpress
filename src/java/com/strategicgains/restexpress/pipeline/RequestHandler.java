...
extends SimpleChannelUpstreamHandler
{
	...
	public RequestHandler(RouteResolver routeResolver, ResponseProcessorResolver responseProcessorResolver)
	{
	...
	public <T extends Throwable, U extends ServiceException> RequestHandler mapException(Class<T> from, Class<U> to)
	{
		exceptionMap.map(from, to);
		return this;
	}
	
	public RequestHandler setExceptionMap(ExceptionMapping map)
	{
