...
public class RestExpress {
     ...
     *
     * @param routes a RouteDeclaration that declares the URL routes that this
     *               service supports.
     */
    public RestExpress() {
        super();
    ...
    private static NioEventLoopGroup getEventExecutorsWithThreadCountOf(int nThreads) {
        if (nThreads > 0) {
