...
>>>>>>> master:core/src/java/com/strategicgains/restexpress/Request.java
	{
		super();
		this.httpRequest = request;
		this.protocol = request.getProtocolVersion().getProtocolName().toLowerCase();
		this.effectiveHttpMethod = request.getMethod();
<<<<<<< HEAD:src/java/com/strategicgains/restexpress/Request.java
...
<<<<<<< HEAD:src/java/com/strategicgains/restexpress/Request.java
	public Request(MessageEvent event)
	{
		this((HttpRequest) event.getMessage());
=======
