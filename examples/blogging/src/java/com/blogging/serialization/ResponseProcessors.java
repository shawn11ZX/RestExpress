...
public class ResponseProcessors
{
	...
	private static final SerializationProcessor JSON_SERIALIZER = new BlogJsonProcessor();
	private static final SerializationProcessor XML_SERIALIZER = new BlogXmlProcessor();
